...
QUESTION_DATA = {
    ...
    "dungeon_cleared": {
        ...
        "speaker": "기억의 사제",
        "lines": [
            "모든 것이 끝났군요... 정말 수고 많으셨습니다.",
            "혹시 궁금하실까 봐 말씀드립니다.",
            "던전은 사라지지 않았습니다.",
            "어둠의 신이 쓰러지면서 던전도 붕괴할 뻔했지만...",
            "당신 덕분에 제 힘이 돌아왔습니다.",
            "오랫동안 잃어버렸던 힘을... 되찾았지요.",
            "그래서 제가 직접 어둠의 ㅅ,",
            "아니 옛용사의 기억을 토대로 던전을 유지시키고 있습니다.",
            "물론 이제 어둠의 힘은 사라졌습니다.",
            "몬스터들도 예전만큼 흉폭하지 않을 겁니다.",
            "하지만 완전히 사라진 것은 아니지요.",
            "그러니 수련을 원하신다면 언제든 던전을 이용하셔도 됩니다.",
            "메모리아의 영웅이시여, 앞으로도 좋은 여정이 되시길 바랍니다."
        ],
        "unlock_key": "game_cleared"
    },
}
